...
The failure involves three scales spanning four orders of magnitude, and
...
\midrule
trigger & $\sim10^{-2}\Jkg$ & the marginal pocket whose \emph{sign} flips\\
CAPE response & $0\leftrightarrow224.23\Jkg$ & $E_M$, amplified by the
selector\\
jump of $g$ & $0.838\hPa$ & the map discontinuity that kills the root\\
\bottomrule
\end{tabular}
\end{center}

\noindent
The amplification $10^{-2}\to224\Jkg$ is the selector's doing
(\S\ref{sec:pr77}); the \emph{attenuation} $224\Jkg\to0.838\hPa$ is the
thermodynamics of \eqref{eq:g}, and is worth making exact, because the
