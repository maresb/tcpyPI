...
$\max(\,\cdot\,,0)$ turns a possibly negative signed integral into $0$;
it \emph{is} reachable here, and is half of the issue-77 mechanism.
\end{convention}
...
$-8.0\times10^{-11}\K$\\
$E_M$ across $x_d$ & $0 \leftrightarrow 224.23146\Jkg$ (raw $-60.9$
before clamp)\\
